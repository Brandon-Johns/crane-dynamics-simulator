...
PURPOSE
    Build a predefined crane model:
        'Full Complexity' with pulley, where the hook and payload joined by a hinge
        (like a triple pendulum)
%}

classdef CDSm_C3_sheave < CDSm_C3
methods
    %**********************************************************************
    % Interface: Create
    %***********************************
    function this = CDSm_C3_sheave(varargin)
    ...
    function sys = Build_SystemDescription(this)
        ...
        % Rope length
        % Approximated version has less starting movement - from 'stationary' test
