...
PURPOSE
    Build a predefined crane model:
        Pulley with zero-radius sheaves, where the hook and payload joined by a hinge
        (like a triple pendulum)
...
classdef CDSm_C3_noSheave < CDSm_C3
methods
    %**********************************************************************
    % Interface: Create
    %***********************************
    function this = CDSm_C3_noSheave(varargin)
