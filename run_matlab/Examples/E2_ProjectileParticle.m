...
%%% PURPOSE %%%
Example Simulation: A projectile particle


%%% SYSTEM DESCRIPTION %%%
A particle is released with initial velocity as though shot from a cannon
Air resistance is not included
Therefore, the trajectory is parabolic
...
params.Create('free', 'Lx').SetIC(0, 10);
params.Create('free', 'Ly').SetIC(0, 10);
