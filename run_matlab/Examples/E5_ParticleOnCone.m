...
%%% PURPOSE %%%
Example Simulation: Particle on the surface of a cone


%%% SYSTEM DESCRIPTION %%%
A particle is constrained to move on the surface of a cone
...
% Constraint equation
%   Equation for hourglass: Lz^2 = Lx^2 + Ly^2
%   Equation for cone: Lz = sqrt(Lx^2 + Ly^2)
constraint = Lz - sqrt(Lx^2 + Ly^2);
