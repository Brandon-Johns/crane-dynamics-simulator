...
%%% PURPOSE %%%
Example Simulation:
    Triple point-mass pendulum cart
    The cart is driven by a predefined input


%%% SYSTEM DESCRIPTION %%%
Triple point-mass pendulum attached at the top to a cart that can roll in the horizontal plane
The cart is driven by an external force (hence, energy is not necessarily conserved)
...
d_OA_point = params.Create('input', 'd_OA');
